    ...
    CSRState& csrState)
{
    ...
    case PPC_INST_ADDME:
        ...
        println("\t{}.ca = {}.ca || ({}.u32 != 0);", xer(), xer(), r(insn.operands[1]));
    ...
    case PPC_INST_STFDU:
        println("\t{} = {}.u32 + {};", ea(), r(insn.operands[2]), int32_t(insn.operands[1]));
        println("\tPPC_STORE_U64({}, *reinterpret_cast<uint64_t*>(&{}.f64));", ea(), f(insn.operands[0]));
        println("\t{}.u32 = {};", r(insn.operands[2]), ea());
        break;
    ...
    case PPC_INST_STFSU:
        println("\t{} = {}.u32 + {};", ea(), r(insn.operands[2]), int32_t(insn.operands[1]));
        println("\tPPC_STORE_U32({}, *reinterpret_cast<uint32_t*>(&{}.f32));", ea(), f(insn.operands[0]));
        println("\t{}.u32 = {};", r(insn.operands[2]), ea());
        break;

    case PPC_INST_STFSUX:
        println("\t{} = {}.u32 + {}.u32;", ea(), r(insn.operands[2]), r(insn.operands[1]));
        println("\tPPC_STORE_U32({}, *reinterpret_cast<uint32_t*>(&{}.f32));", ea(), f(insn.operands[0]));
        println("\t{}.u32 = {};", r(insn.operands[2]), ea());
        break;
    ...
    case PPC_INST_VCMPBFP128:
        ...
        for (int i = 0; i < 4; i++) {
            ...
            println("\tif (isnan({1}.f32[{0}]) || isnan({2}.f32[{0}])) {3}.u32[{0}] = 0xC0000000;", i, v(insn.operands[1]), v(insn.operands[2]), v(insn.operands[0]));
            println("\telse {{");
